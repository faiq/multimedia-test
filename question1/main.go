...
func sortState(lineLen int, state map[string]int) PairList {
	pl := make(PairList, lineLen)
	i := 0
...
func ProcessLines(lines []string) map[string]int {
...
func main() {
	...
	sortedMap := sortState(len(lines), state)
